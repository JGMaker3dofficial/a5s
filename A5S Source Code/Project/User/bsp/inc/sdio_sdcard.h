...
#define	SD_DET_IO_ID	KID_JOY_OK		

#define SD_CD	(!bsp_GetKeyState(SD_DET_IO_ID))

//#define SD_CD PFin(10)	//SD ≤Â»ÎºÏ≤‚
#define SD_DETECT_PIN                    GPIO_Pin_10                  /* PC.7 */
#define SD_DETECT_GPIO_PORT              GPIOF                       /* GPIOC */
...
/** 
  ...
  */
#define SDIO_TRANSFER_CLK_DIV            ((uint8_t)0x8E)
