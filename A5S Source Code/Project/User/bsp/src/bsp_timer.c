...
*********************************************************************************************************
*/
#if defined (USE_TIM2) || defined (USE_TIM3)  || defined (USE_TIM5)
...
/*
* Tout = (1/(72000000/psc))*(arr + 1)
TIM4_Int_Init(9,7199);//1ms 中断一次
*/
