...
extern volatile u8 forceAdjust;
_m_tp_dev tp_dev=
{
	TP_Init,
	TP_Scan,
...
//提示字符串
u8* const TP_REMIND_MSG_TBL="Please click the cross...";
...
{								 
	...
	LCD_Clear(WHITE);//清屏 	   
	POINT_COLOR=BLACK;
	LCD_ShowString(40,101,200,100,16,(u8*)TP_REMIND_MSG_TBL);//显示提示信息
...
{	
	  ...
	  GPIO_InitTypeDef  GPIO_InitStructure;
		...
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_7|GPIO_Pin_4;				 // PA端口配置
	 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	 	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	 	GPIO_Init(GPIOA, &GPIO_InitStructure);//推挽输出
	 	GPIO_SetBits(GPIOA,GPIO_Pin_5|GPIO_Pin_7|GPIO_Pin_4);//上拉
		

		
		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;				 // PA6端口配置
	 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU; 		 //上拉输入
	 	GPIO_Init(GPIOA, &GPIO_InitStructure);//PA6上拉输入
	 	GPIO_SetBits(GPIOA,GPIO_Pin_6);//上拉		
 
 		GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4;				 // PC4端口配置
	 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IPU; 		 //上拉输入
	 	GPIO_Init(GPIOC, &GPIO_InitStructure);//PC上拉输入
