...
/*
*********************************************************************************************************
*	功能说明: 通过直接操作串口数据寄存器来发送一个字节
*	形    参: c：要发送的字符
*	返 回 值: 无
*********************************************************************************************************
*/
void simple_uart_putc(USART_TypeDef* USARTx, const uint8_t c)	// 发送1个byte
{
...
/*
*********************************************************************************************************
*	功能说明: 通过直接操作串口数据寄存器来发送一个字符串
*	形    参: str：要发送的字符串首地址
*	返 回 值: 无
*********************************************************************************************************
*/
void simple_uart_putstring(USART_TypeDef* USARTx, const uint8_t *str)	// 发送字符串
{
	uint8_t i = 0;
	uint8_t ch = str[i++];
	while (ch != '\0')
