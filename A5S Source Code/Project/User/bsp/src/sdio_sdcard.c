...
void SD_LowLevel_Init(void)
{
	...
	/*!< Configure SD_SPI_DETECT_PIN pin: SD Card detect pin *///中断检测
...
*********************************************************************************************************
*
*	下面的中断代码是从另外的文件  stm32_it.c 整合进来的
*
*
*********************************************************************************************************
*/
...
{
	u8 retvlue ;
	retvlue = bsp_GetKeyState(SD_DET_IO_ID);
