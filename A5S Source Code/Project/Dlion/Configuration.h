...
#define ZHONG_XING	0	//中性项目----去掉开机logo

#define A3_LIN_SHI	0	// A3临时版（进退料较长），为消耗库存

#define EN_DISP_COMPANY_NAME	0	//关于界面显示公司名称使能

#define EN_QR_CODE				0	//定义使用二维码

//#include "setup.h"

#define CUSTOMER_USA	0	// 美国客户定制
...
#define TEMP_HYSTERESIS 5       // (degC) range of +/- temperatures considered "close" to the target one//updated by tony
...
#define EXTRUDE_MAXLENGTH (1000)//add by tony,
...
#define DISABLE_E 0 // For all extruders
	...
	#define INVERT_Z_DIR FALSE    // for Mendel set to FALSE, for O      rca set to TRUE
...
//////////////////////////////////////////////////////////////
#elif MERCHIN == A3
	#define X_MAX_POS 205       //changed by tony 2018-11-29                                                                                                  
	#define X_MIN_POS 0
...
//////////////////////////////////////////////////////////////
#elif MERCHIN == A5
	#if CUSTOMER_USA==1	// 美国客户定制
		#define X_MAX_POS 280                                  
		#define X_MIN_POS 5
		#define Y_MAX_POS 268
		#define Y_MIN_POS 0
...
#if	MERCHIN == A1
	#define HOMING_FEEDRATE {50*60, 50*60, 20*60, 0} 
	#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,1600,202}//32 mic step									 
	#define DEFAULT_MAX_FEEDRATE          {300, 300, 10, 25}    // (mm/sec)   
	#define DEFAULT_MAX_ACCELERATION      {300,300,100,400}// X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.																				  
...
#elif MERCHIN == A3
	#define HOMING_FEEDRATE {50*60, 50*60, 20*60, 0} 
 	#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,1600,212}//32 mic step                   
	#define DEFAULT_MAX_ACCELERATION      {1000,1000,500,1500}
	#define DEFAULT_MAX_FEEDRATE          {300, 300, 10, 25}    // (mm/sec)
...
#elif MERCHIN == A4
	#define HOMING_FEEDRATE {50*60, 50*60, 20*60, 0} 
 	#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,133,800,212}//32 mic step                   
	#define DEFAULT_MAX_ACCELERATION      {1000,1000,500,1500}
	#define DEFAULT_MAX_FEEDRATE          {300, 300, 10, 25}    // (mm/sec)
	#define DEFAULT_ACCELERATION          500    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
	#define DEFAULT_RETRACT_ACCELERATION  500   // X, Y, Z and E max acceleration in mm/s^2 for r retracts  
...
#elif MERCHIN == A6
	#define HOMING_FEEDRATE {50*60, 50*60, 20*60, 0} 
	#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,1600,190}//DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,1600,202}//32 mic step                      
	#define DEFAULT_MAX_FEEDRATE          {300, 300, 10, 25}    // (mm/sec)                     
	#define DEFAULT_MAX_ACCELERATION      {300,300,100,400}// X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.                                                                                              
	#define DEFAULT_ACCELERATION          300    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
	#define DEFAULT_RETRACT_ACCELERATION  100   // X, Y, Z and E max acceleration in mm/s^2 for r retracts  
