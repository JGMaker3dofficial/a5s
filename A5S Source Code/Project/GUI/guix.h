...
__packed typedef struct 
{
	...
	void(*fill_dma)(u16,u16,u16,u16,u16);		//单色填充函数 	  
...
void gui_show_strmid(u16 x,u16 y,u16 width,u16 height,u16 color,u8 size,u8 *str,u8 mode);//更改
...
void delet_file_suffix(u8 *pnDes,u8 *pnSr);
